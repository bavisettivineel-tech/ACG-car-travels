...
const testimonials = [
  {
    text: "Excellent service! The driver was very professional and reached on time. The car was clean and comfortable. Highly recommend Indhra Kheladri Travels for any trip.",
    name: "Ravi Kumar",
    location: "Jaggampeta",
