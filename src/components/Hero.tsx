    ...
    >
      ...
      >
        ...
        >
          <img
            src={heroCar}
            alt="Toyota Fortuner luxury SUV — Sri Satyadeva Car Travels premium fleet"
            width={1920}
            height={1280}
        ...
        <div className="pointer-events-auto max-w-2xl">
          ...
          >
            ...
            <span className="text-[10px] sm:text-xs uppercase tracking-widest text-gold">
              ★ 5.0 Rated · Open 24 Hours · Pro. Ragampeta
            </span>
          </motion.div>
          ...
          >
            <span className="block gold-text-gradient drop-shadow-[0_4px_30px_rgba(201,168,76,0.3)]">SRI SATYADEVA</span>
          ...
          >
            Premium Car Rentals · Pro. Ragampeta, Andhra Pradesh
          </motion.p>
