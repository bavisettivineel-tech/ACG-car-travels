    ...
    <footer className="bg-[#020202] border-t border-gold/15 pt-16 pb-6 grain relative">
      ...
      <div className="max-w-7xl mx-auto px-5">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            <div itemScope itemType="https://schema.org/LocalBusiness">
              ...
              <p className="mt-4 text-sm text-foreground/55 leading-relaxed">
                Amalapuram's nearest car travels and cab service, serving passengers across AP and Telangana with 5-star rated service. Call anytime: <a href="tel:+917382352666" aria-label="Call ACG Car Travels" className="text-gold hover:text-gold-light">+91 73823 52666</a>.
              </p>
              <address className="mt-3 text-xs text-foreground/40 not-italic leading-relaxed" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
              ...
              <div className="flex gap-3 mt-5">
                <a href="https://wa.me/917382352666?text=Hi, I want to book a cab with ACG Car Travels Amalapuram" target="_blank" rel="noopener noreferrer" aria-label="Chat with ACG Car Travels on WhatsApp" title="WhatsApp ACG Car Travels — Amalapuram Car Travels" className="w-10 h-10 rounded-full border border-gold/40 flex items-center justify-center text-gold hover:bg-gold hover:text-black transition-colors">
                  <MessageCircle size={18} aria-hidden="true" />
                </a>
                <a href="tel:+917382352666" aria-label="Call ACG Car Travels at +91 7382352666" title="Call ACG Car Travels — Best Car Travels Amalapuram" className="w-10 h-10 rounded-full border border-gold/40 flex items-center justify-center text-gold hover:bg-gold hover:text-black transition-colors">
                  <Phone size={18} aria-hidden="true" />
                </a>
                <a href="https://maps.google.com/?q=ACG+Car+Travels+Amalapuram" target="_blank" rel="noopener noreferrer" aria-label="Find ACG Car Travels on Google Maps" title="ACG Car Travels Location — Amalapuram" className="w-10 h-10 rounded-full border border-gold/40 flex items-center justify-center text-gold hover:bg-gold hover:text-black transition-colors text-xs font-bold">
        ...
        <div className="pt-6 border-t border-gold/10 flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-foreground/40">
          <div>© 2026 <strong className="text-foreground/60">ACG Car Travels</strong>, Amalapuram, Andhra Pradesh. All rights reserved. | <span className="text-gold/60">Best Car Travels &amp; Cab Service Amalapuram</span></div>
