...
const packages = [
  {
    ...
    desc: "Comfortable rides within Jaggampeta for all daily needs",
    includes: ["Point to point drops", "AC vehicles", "Affordable rates", "All city areas covered"],
    msg: "Hi, I need a Local Drop in Jaggampeta",
  },
  {
    icon: Route,
    ...
    msg: "Hi, I need an Outstation Trip from Jaggampeta",
    featured: true,
  },
  {
    icon: Plane,
    ...
    msg: "Hi, I need an Airport Transfer from Jaggampeta",
  },
  {
    icon: Mountain,
    name: "Tour Packages",
    ...
    msg: "Hi, I need a Tour Package from Jaggampeta",
  },
  {
    icon: Heart,
    name: "Wedding & Events",
    ...
    msg: "Hi, I need Wedding Car Service from Jaggampeta",
  },
  {
    icon: Briefcase,
    ...
    msg: "Hi, I need Corporate Travel Service from Jaggampeta",
  },
];
  ...
  return (
    <Section id="packages" label="Packages" title="Every Journey Covered">
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {packages.map((p, i) => {
          const link = `https://wa.me/917569239382?text=${encodeURIComponent(p.msg)}`;
          return (
            <motion.div
              key={p.name}
