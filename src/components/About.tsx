...
export function About() {
  return (
    <Section id="about" label="About Us" title="Ragampeta's Most Trusted Car Service">
      <div className="grid lg:grid-cols-2 gap-12 items-start">
        ...
        >
          <p className="text-foreground/70 text-lg leading-relaxed mb-8">
            Sri Satyadeva Car Travels is Pro. Ragampeta's most trusted car rental &amp; cab service, proudly serving
            ...
            Pro. Ragampeta to Hyderabad, Visakhapatnam, Vijayawada, Tirupati, Rajahmundry and beyond.
          </p>
