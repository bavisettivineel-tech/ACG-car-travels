...
const cars: CarItem[] = [
  {
    ...
    price: "₹12/km",
    image: sedanImg,
    whatsapp: "Hi, I want to book a Sedan from Sri Satyadeva Car Travels",
  },
  {
    type: "Premium Class",
    ...
    price: "₹16/km",
    image: innovaImg,
    whatsapp: "Hi, I want to book an Innova Crysta from Sri Satyadeva Car Travels",
  },
  {
    type: "Group Travel",
    ...
    price: "₹22/km",
    image: tempoImg,
    whatsapp: "Hi, I want to book a Tempo Traveller from Sri Satyadeva Car Travels",
  },
  {
    type: "Family MPV",
    name: "Maruti Ertiga",
    ...
    price: "₹14/km",
    image: ertigaImg,
    whatsapp: "Hi, I want to book a Maruti Ertiga from Sri Satyadeva Car Travels",
  },
  {
    type: "Compact Sedan",
    name: "Honda Amaze",
    ...
    price: "₹13/km",
    image: amazeImg,
    whatsapp: "Hi, I want to book a Honda Amaze from Sri Satyadeva Car Travels",
  },
];

function CarCard({ car, index }: { car: CarItem; index: number }) {
  const link = `https://wa.me/919000838395?text=${encodeURIComponent(car.whatsapp)}`;
